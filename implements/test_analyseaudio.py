...
from MusiCoreTest.implements import analyseaudio

# test en analyse
analyse_bpm.analyse_bpm("/home/bettini/Musique/Deorro.wav",
                        "fichier_csv")  # test (.wav, chemin correct jusqu'au fichier)
